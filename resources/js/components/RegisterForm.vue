<template>
    <div class="space-y-4" v-cloak>
        <div class="grid md:grid-cols-2 gap-3">
            ...
            <div>
                <label for="regFullName" class="block text-xs font-bold text-gray-900 mb-1 uppercase tracking-wide">Nombres y Apellidos</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid md:grid-cols-2 gap-3">
            ...
            <div>
                <label for="regPhone" class="block text-xs font-bold text-gray-900 mb-1 uppercase tracking-wide">WhatsApp</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 32 32">
        ...
        <div class="flex items-center gap-3 pt-2">
            ...
            >
                ...
                {{ loadingSubmit ? "Enviando..." : "Crear cuenta ahora" }}
            </button>
        </div>
