export const deletable = {
    methods: {
        ...
        resetpassword(url) {
            return new Promise((resolve) => {
                this.$confirm('¿Desea resetear el password del usuario Seleccionado ?', 'Aviso', {
                    ...
                    this.$http.get(url)
                        .then(res => {
                            if (res.data.success) {
                                this.$message.success('Se reseteo el password correctamente')
                                resolve()
                            }
                        })
                        .catch(error => {
        ...
        reset(url) {
            return new Promise((resolve) => {
                this.$confirm('¿Desea resetear el conteo de Consultas?', 'Aviso', {
                    confirmButtonText: 'Aceptar',
                    cancelButtonText: 'Cancelar',
                    type: 'warning'
                }).then(() => {
                    this.$http.get(url)
                        .then(res => {
                            if (res.data.success) {
                                this.$message.success('Se reseteo correctamente el registro')
                                resolve()
                            }
                        })
                        .catch(error => {
